  ...
  return (
    <Layout>
      <div style={{ background: '#fcfcfd', color: '#24276F' }}>
        ...
        {/* The Team Section */}
        {teamItems.length > 0 && (
          <section style={{ padding: isMobile ? '60px 20px' : '120px 64px', background: '#f8fafc' }}>
              <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: isMobile ? 40 : 64 }}>
                  <h2 style={{ fontSize: isMobile ? 28 : 36, fontWeight: 900, marginBottom: 16 }}>Meet Our <span style={{ color: 'var(--accent-gold)' }}>Leadership</span></h2>
                  <p style={{ color: '#64748b', fontSize: 14 }}>The experts ensuring your safe and seamless travel.</p>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? 24 : 32 }}>
                  {teamItems.map((person, i) => (
                    ...
                    >
                      ...
                      <h3 style={{ fontSize: 17, fontWeight: 900, marginBottom: 4 }}>{person.name}</h3>
                      <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--accent-gold)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 16 }}>{person.role}</div>
                      <p style={{ fontSize: 13, color: '#64748b', lineHeight: 1.6, margin: 0 }}>{person.bio}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
