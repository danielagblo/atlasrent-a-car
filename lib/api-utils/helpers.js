...
async function buildInvoiceBuffer(order) {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fillColor('#24276F').fontSize(26).text('ATLAS RENT-A-CAR', 40, 40)
      doc.fillColor('#333333').fontSize(10).text('Premium Car Rental & Luxury Fleet Services', 40, 75)
      ...
      doc.fillColor('#24276F').fontSize(12).text('RESERVATION SPECIFICATIONS', 40, doc.y)
      doc.moveDown(1.5)
      ...
      // Financial Terms
      doc.fontSize(12).fillColor('#24276F').text('FINANCIAL TERMS & NOTES', 40, doc.y)
      doc.moveDown(1)
      ...
      // Footer
      doc.fontSize(8).fillColor('#aaaaaa').text('Atlas Rent-A-Car - Accra, Ghana | atlasrentacargh.com', 40, 780, { align: 'center' })
